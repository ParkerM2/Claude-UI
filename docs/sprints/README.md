...
| Sprint | Theme | Status |
|--------|-------|--------|
| [Sprint 0.5](./sprint-0.5-design-system.md) | Design System Foundation (UI primitives + forms) | NOT STARTED |
| [Sprint 1](./sprint-1-core-hardening.md) | Core Hardening (install → task → PR) | NOT STARTED |
